...
public class main {
    ...
    private static Map<String, Test> initializeTests(Wini config)
    {
        ...
        tests.put("calls", new CallsTest(config));
        tests.put("coordinator", new CordinatorTest(config));
        tests.put("productivityAgents", new ProductivityAgentsTest(config));
        tests.put("productivityExport", new ProductivityExportTest(config));
        tests.put("oldRecordDownload", new OldRecordDownloadTest(config));
